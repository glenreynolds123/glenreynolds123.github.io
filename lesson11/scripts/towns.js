        ...
        towns.forEach(
            town => {
                ...
                if (town.name === 'Fish Haven') {
                    ...
                    document.querySelector('#prestonAverageRainfall').textContent = `Average Rainfall: ${town.averageRainfall}`;
                    document.querySelector('#prestonImage').setAttribute
                        ('src', `images/${town.photo}`);
                    document.querySelector('#prestonImage').setAttribute
                        ('alt', town.name);
                    ...
                    document.querySelector('#sodaSpringsAverageRainfall').textContent = `Average Rainfall: ${town.averageRainfall}`;
                    document.querySelector('#sodaSpringsImage').setAttribute
                        ('src', `images/${town.photo}`);
                    document.querySelector('#sodaSpringsImage').setAttribute
                        ('alt', town.name);
                }
